...
#cv by default NONE: 5-fold cross validation
grid_svm = GridSearchCV(svm.SVC(), tuned_parameters, scoring='accuracy', n_jobs=-1, cv=None,verbose=2)
grid_svm.fit(X_train, y_train)
best=grid_svm.best_estimator_
preds=best.predict(df_test_valid_X)