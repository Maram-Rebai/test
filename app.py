...
def predict():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            #pickle.dump(model_svc, open(modelname, 'wb'))
            ...
            result=[]
            models = {'Catboost':cbc, 'XGBoost':xgbc, 'Gradient Boosting':gbc, 'AdaBoost':abc,  'Linear Regression':lr, 'KNN':cls ,'Random Forest':xgbc } #'Random Forest':rfc,
